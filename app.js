...
const server = http.createServer((req, res) => {
     ...
     if(req.url === '/') {
        ...
        res.write(`<html><head><title>Responce</title></head><body><h1>${msg}</h1><form action="/msg" method="post"><input type="text" name="text"><input type="submit" value="send"></form></body></html>`);
